...
do
    ...
    #batch -J mpileup.$i --mem=10G -o $prefix/mpileup/individual_bams/logs/$i.o -e $prefix/mpileup/individual_bams/logs/$i.e --time=500 -p akundaje,euan,owners,normal run_mpileup.sh $cur_bam $outf $ref
    ./run_mpileup.sh $cur_bam $outf $ref &
done
