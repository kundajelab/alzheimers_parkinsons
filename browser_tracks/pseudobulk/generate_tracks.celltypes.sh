prefix=/oak/stanford/groups/akundaje/projects/alzheimers_parkinsons/pseudobulk/pseudobulk_outputs_celltypes
python generate_tracks.py --pval_bigwigs $prefix/pval.signal.bigwig \
    --fc_bigwigs $prefix/fc.signal.bigwig  \
    --hammocks $prefix/idr.optimal_peak.narrowPeak.hammock.txt \
