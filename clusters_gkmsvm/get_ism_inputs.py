...
def make_fasta(snps, cluster):
    effect_fasta = open('/mnt/lab_data3/soumyak/adpd/ism_inputs/Cluster'+cluster+'.effect.fasta', 'w')
    noneffect_fasta = open('/mnt/lab_data3/soumyak/adpd/ism_inputs/Cluster'+cluster+'.noneffect.fasta', 'w')
    counter = 0
