...
def create_new_notebook(cluster):
    ...
    with open("/users/soumyak/alzheimers_parkinsons/snp_scoring_notebooks/template.ipynb") as f:
    ...
    # Save
    with open("/users/soumyak/alzheimers_parkinsons/snp_scoring_notebooks/Cluster%s.ipynb" % str(cluster), 'w') as f:
