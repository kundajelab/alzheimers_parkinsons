CUDA_VISIBLE_DEVICES=$2 kerasAC_cross_validate \
		    ...
		    --model_hdf5 /mnt/lab_data3/soumyak/adpd/deeplearning/models/regression/single_cell/$1.nothresh.model \
		    ...
		    --performance_metrics_regression_file /mnt/lab_data3/soumyak/adpd/deeplearning/predictions/regression/single_cell/performance/$1.nothresh.perfs \
		    --predictions_pickle /mnt/lab_data3/soumyak/adpd/deeplearning/predictions/regression/single_cell/pickles/$1.nothresh.preds \
			#--vcf_file $3 \
