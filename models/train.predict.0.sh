#split 0
CUDA_VISIBLE_DEVICES=3 kerasAC_train --nonzero_bin_path /mnt/lab_data2/annashch/adpd/model_inputs/input.hdf5 \
		    --universal_negative_path /mnt/lab_data2/annashch/adpd/model_inputs/universal_negatives.input.hdf5 \
...
CUDA_VISIBLE_DEVICES=3 kerasAC_predict  --nonzero_bin_path /mnt/lab_data2/annashch/adpd/model_inputs/input.hdf5 \
		    --universal_negative_path /mnt/lab_data2/annashch/adpd/model_inputs/universal_negatives.input.hdf5 \
		    --model_hdf5 adpd.regression.0 \
		    --batch_size 1000 \
		    --predict_chroms chr1 \
