...
def main():
    ...
    for fold in folds:
        ...
        classification=pickle.load(open(args.pickle_classification_dir+"/sig.snps.Cluster"+args.cluster+".fold"+str(fold)+".classification",'rb'))
        print("loaded classification pickle") 
        regression=pickle.load(open(args.pickle_classification_dir+"/sig.snps.Cluster"+args.cluster+".fold"+str(fold)+".regression",'rb'))
