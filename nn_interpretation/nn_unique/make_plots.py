...
def parse_args():
    ...
    parser.add_argument("--pickle_gkm_dir",default="/srv/scratch/annashch/deeplearning/adpd/interpret/svm_for_nn_sig")    
...
def main():
    ...
    classification=pickle.load(open(args.pickle_classification_dir+"/nn_unique.Cluster"+args.cluster+".fold"+args.fold+".classification",'rb'))
    print("loaded classification pickle") 
    regression=pickle.load(open(args.pickle_classification_dir+"/nn_unique.Cluster"+args.cluster+".fold"+args.fold+".regression",'rb'))
