...
def parse_args():
    ...
    parser.add_argument("--score_dir",default="/mnt/lab_data3/soumyak/adpd/nn_analysis")
    parser.add_argument("--snp_dir",default="/mnt/lab_data3/soumyak/adpd/nn_analysis/")
