...
def snps_in_peaks(snps):
    ...
    for i in range(1, 25):
        ...
        overlap_peaks = '/oak/stanford/groups/akundaje/projects/alzheimers_parkinsons/pseudobulk/pseudobulk_outputs/peaks/idr_peaks_bedtools_merged/Cluster'+str(i)+'.idr.optimal.narrowPeak'
        ...
        #intersect_df.to_csv('/home/groups/akundaje/soumyak/alzheimers_parkinsons/scoring_new_snps/old_snps_in_overlap_peaks/Cluster'+str(i)+'.new.overlap.expanded.snps.hg38.bed', sep='\t', index=False)
        intersect_df.to_csv('/oak/stanford/groups/akundaje/projects/alzheimers_parkinsons/snps_in_idr_peaks/Cluster'+str(i)+'.new.overlap.expanded.snps.hg38.bed', sep='\t', index=False)
