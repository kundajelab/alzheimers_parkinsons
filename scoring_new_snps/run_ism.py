...
def main(args):
    if not os.path.isdir('/home/groups/akundaje/soumyak/alzheimers_parkinsons/scoring_new_snps/ism_scores/Cluster'+args[0]):
        os.mkdir('/home/groups/akundaje/soumyak/alzheimers_parkinsons/scoring_new_snps/ism_scores/Cluster'+args[0])
