...
def make_fasta(nn_snps):
    effect_fasta = open('/mnt/lab_data3/soumyak/adpd/nn_analysis/nn.ism.effect.fasta', 'w')
    noneffect_fasta = open('/mnt/lab_data3/soumyak/adpd/nn_analysis/nn.ism.noneffect.fasta', 'w')
    counter = 0
